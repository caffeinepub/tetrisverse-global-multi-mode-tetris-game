...
const ALL_MODES: GameMode[] = [
  'classic', 'timeAttack', 'endless', 'challenge',
  'puzzle', 'insanity', 'mirror', 'gravityShift', 'comboRush',
];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full max-w-2xl mx-auto w-full px-4">
        {/* Header */}
        <div className="flex items-center gap-3 py-4 border-b" style={{ borderColor: border }}>
          <button
            onClick={onBack}
        ...
        {/* Mode tabs */}
        <div className="flex gap-1.5 flex-wrap py-3 border-b" style={{ borderColor: border }}>
          {ALL_MODES.map(mode => (
            <button
              key={mode}
        ...
        <div className="flex-1 overflow-auto py-3">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 gap-3">
              <Trophy size={40} style={{ color: isLight ? 'rgba(0,0,0,0.2)' : 'rgba(255,255,255,0.2)' }} />
