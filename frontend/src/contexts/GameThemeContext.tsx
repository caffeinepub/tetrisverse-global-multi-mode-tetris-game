...
export type ThemeName = 'neon' | 'retro' | 'minimal' | 'space' | 'ocean' | 'candy' | 'sunrise' | 'pixelCity';
...
export const THEMES: Record<string, GameTheme> = {
  neon: {
    ...
    accentColor: '#00f5ff',
    blockColors: ['#00f5ff', '#bf00ff', '#ff3366', '#00ff88', '#ffd700', '#ff8800', '#0066ff'],
  ...
  retro: {
    ...
    accentColor: '#ff8c00',
    blockColors: ['#ff8c00', '#ff4500', '#ffd700', '#ff6347', '#ff1493', '#dc143c', '#ff69b4'],
  ...
  minimal: {
    ...
    accentColor: '#0066cc',
    blockColors: ['#333333', '#555555', '#0066cc', '#cc3300', '#006633', '#663300', '#330066'],
  ...
  space: {
    ...
    accentColor: '#44ffcc',
    blockColors: ['#4488ff', '#8844ff', '#44ffcc', '#ff4488', '#ffcc44', '#44ff88', '#ff8844'],
  ...
  ocean: {
    ...
    accentColor: '#00e5ff',
    blockColors: ['#00bcd4', '#0288d1', '#00e5ff', '#26c6da', '#4dd0e1', '#006064', '#00838f'],
  ...
  candy: {
    ...
    accentColor: '#ff44cc',
    blockColors: ['#e91e8c', '#9c27b0', '#ff5722', '#e53935', '#8e24aa', '#d81b60', '#c62828'],
  ...
  sunrise: {
    ...
    accentColor: '#ff6600',
    blockColors: ['#ff6600', '#ff8800', '#ffaa00', '#ff3300', '#ffcc00', '#ff0000', '#ffdd00'],
  ...
  pixelCity: {
    ...
    accentColor: '#44ff44',
    blockColors: ['#58a6ff', '#f78166', '#3fb950', '#d2a8ff', '#ffa657', '#79c0ff', '#56d364'],
...
export function GameThemeProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <GameThemeContext.Provider value={{
      currentTheme,
      theme: currentTheme,
      setTheme,
      themeId,
