...
export default function TouchControlButtons({
  ...
  const btnSize =
    typeof window !== "undefined" && window.innerWidth <= 360 ? "44px" : "50px";
  const iconSize =
    typeof window !== "undefined" && window.innerWidth <= 360 ? 18 : 20;
  ...
  return (
    <div
      className="flex flex-col items-center gap-1.5 md:hidden select-none"
    ...
    >
      ...
      <div className="flex gap-3">
        ...
        <button
          type="button"
          style={btnStyle}
          {...makeHandler("hardDrop", onHardDrop)}
