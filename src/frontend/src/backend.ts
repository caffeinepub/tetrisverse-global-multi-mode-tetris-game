...
export class Backend implements backendInterface {
    ...
    async addMission(arg0: string, arg1: bigint, arg2: string, arg3: bigint, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addMission(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllScores(arg0: string): Promise<Array<ScoreEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllScores(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMissionReward(arg0: string, arg1: bigint): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getMissionReward(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isMissionCompleted(arg0: string, arg1: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isMissionCompleted(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitScore(arg0: string, arg1: bigint, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateMissionProgress(arg0: string, arg1: bigint, arg2: bigint): Promise<boolean> {
        if (this.processError) {
            try {
